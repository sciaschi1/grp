...
NoticeMaterial[ NOTIFY_GENERIC ] = Material( "notifications/generic.png" )
NoticeMaterial[ NOTIFY_ERROR ] = Material( "notifications/error.png" )
NoticeMaterial[ NOTIFY_UNDO ] = Material( "notifications/undo.png" )
NoticeMaterial[ NOTIFY_HINT ] = Material( "notifications/hint.png" )
NoticeMaterial[ NOTIFY_CLEANUP ] = Material( "notifications/cleanup.png" )
...
function draw.Circle( x, y, radius, seg )
	local cir = {}
	//print("Showing circle..... somewhere")
...
function PANEL:Paint( w, h )
	...
	draw.NoTexture()
	draw.Circle( 30, y + (h / 2), (h / 3) + 5 , 100 )
